...
var $ = require('jquery');
var messageReducer = require('../../reducers/indexReducers.js');
...
var MessageComponent = React.createClass({
  ...
  render:function(){
    var arr = [];
    console.log(this)
    for(var key in this.props.messageReducers._response[0]){
      arr.push(key);
    }
    return(
      ...
      {this.props.messageReducers._response.map(function(item,index){
        return (<tr>
          <td>{item.indexid}</td>
